...
from .service import async_set_service_schema, integration_service_call
...
class ServicePlatform:
    ...
    async def _set_service_description(
        ...
        services_dict = cast(
            dict, await self.hass.async_add_executor_job(load_yaml, str(services_yaml))
        )
